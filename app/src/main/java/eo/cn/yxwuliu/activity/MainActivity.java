...
import eo.cn.yxwuliu.fragment.CategorizeFragment;
import eo.cn.yxwuliu.fragment.HomeFragment;
import eo.cn.yxwuliu.fragment.PersonFragment;
import eo.cn.yxwuliu.fragment.PurchaseOrderFragment;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private CategorizeFragment mCategorizeFragment;
    private PurchaseOrderFragment mPurchaseOrderFragment;
        ...
        for (int i = 0; i < mFragmentTags.length; i++) {
            ...
            if(fragment != null){
                if (fragment instanceof HomeFragment) {
                    ...
                    mPurchaseOrderFragment = (PurchaseOrderFragment)fragment;
                } else if (fragment instanceof CategorizeFragment) {
                    mCategorizeFragment = (CategorizeFragment)fragment;
...
//        intent.putExtras(bundle);
    ...
    public void onTabSelect(LinearLayout itemLayout) {
        ...
        if (id == R.id.layout_home) {
            ...
            selectedFragment(transaction, mCategorizeFragment, CategorizeFragment.class, FRAGMENT_TAG_Categorize);
        } else if (id == R.id.layout_product) {
            selectedFragment(transaction, mPurchaseOrderFragment, PurchaseOrderFragment.class, FRAGMENT_TAG_PURCHASE_ORDER);
