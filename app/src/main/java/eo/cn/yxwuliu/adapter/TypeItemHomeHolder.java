...
import eo.cn.yxwuliu.holder.TypeBaseViewHolder;
import eo.cn.yxwuliu.widgets.OrderDialog;
import eo.cn.yxwuliu.widgets.RoundImageView;

import static eo.cn.yxwuliu.R.id.book_num_tv;
import static eo.cn.yxwuliu.R.id.face_im;
import static eo.cn.yxwuliu.R.id.g_name_tv;
import static eo.cn.yxwuliu.R.id.g_role_tv;
import static eo.cn.yxwuliu.R.id.tv_cars_go_need;
import static eo.cn.yxwuliu.R.id.tv_distance;
import static eo.cn.yxwuliu.R.id.tv_register_time;
import static eo.cn.yxwuliu.R.id.tv_starting;
...
public class TypeItemHomeHolder extends TypeBaseViewHolder<GoodsBean.DataBean> implements View.OnClickListener {
    ...
    public TypeItemHomeHolder(View itemView) {
        super(itemView);
        mFace_im = (RoundImageView) itemView.findViewById(face_im);
        role_tv = (TextView) itemView.findViewById(g_role_tv);
        name_tv = (TextView) itemView.findViewById(g_name_tv);
        num_tv = (TextView) itemView.findViewById(book_num_tv);
        register_time = (TextView) itemView.findViewById(tv_register_time);
        time_tv = (TextView) itemView.findViewById(R.id.msg_time_tv);//发布班信息的时间
        mTv_starting = (TextView) itemView.findViewById(tv_starting);
        ...
        cars_go_need = (TextView) itemView.findViewById(tv_cars_go_need);
        mTv_distance = (TextView) itemView.findViewById(tv_distance);
